...
<c:set var = "order" value = "desc"/>
	...
	<li role="presentation" class="active">
		<a id="get-all-tab"
		   ...
		   role="tab"
		   data-toggle="tab">
			<spring:message code = "crsms.admin.pane.get.all"/> <b>(${rowscount})</b>
		</a>
	</li>
	<li role="presentation">
		<a id = "teacher-request-tab"
		   href="#teacher-request-pane"
		   aria-controls="teacher-request-pane"
		   role="tab"
		   data-toggle="tab">
...
<div role="tabpanel"class="tab-pane fade" id="teacher-request-pane">	
<table class="table table-bordered table-hover">
		<thead>
			<tr >
				...
				<th>
					<spring:message code="crsms.admin.teacher.request.date" />
					<a href="<c:url value="?sortparam=isEnabled&direction=${order}&keyWord=${keyWord}&itemsperpage=${itemsperpage}"/>">
						<c:choose>
							<c:when test="${sortparam == 'isEnabled' && direction == 'asc'}">
								<i class="fa fa-sort-alpha-desc fa-lg"></i>
				...
				<th>
					<spring:message code="crsms.admin.teacher.request.approved" />
					<a href="<c:url value="?sortparam=isEnabled&direction=${order}&keyWord=${keyWord}&itemsperpage=${itemsperpage}"/>">
						<c:choose>
							<c:when test="${sortparam == 'isEnabled' && direction == 'asc'}">
								<i class="fa fa-sort-alpha-desc fa-lg"></i>
				...
				<th>
					<spring:message code="crsms.admin.teacher.review.date" />
					<a href="<c:url value="?sortparam=isEnabled&direction=${order}&keyWord=${keyWord}&itemsperpage=${itemsperpage}"/>">
						<c:choose>
							<c:when test="${sortparam == 'isEnabled' && direction == 'asc'}">
								<i class="fa fa-sort-alpha-desc fa-lg"></i>
		...
		<tbody>
			<c:forEach items="${requests}" var="request">
				<tr>
					...
					<td class="managementCell">${request.user.role.name}</td>
					<td class="managementCell" align="center">
					<c:choose>
							<c:when test="${request.user.isEnabled == 'true'}">
						    	<span class="glyphicon glyphicon-ok-circle text-success"
							    	data-toggle="tooltip"
							    	title="<spring:message code="crsms.admin.enabled" />">
						    	</span>
