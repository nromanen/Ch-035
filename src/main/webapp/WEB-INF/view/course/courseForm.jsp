...
<form:form modelAttribute = "course" class="form-horizontal" method="POST" >
	...
	<div class="form-group">
		<label for="start" class="col-sm-2 control-label"><spring:message code="crsms.courses.text.startDate" /></label>
		<div class="col-sm-10" >
			<div class='input-group date' id='datetimepicker1' >
				<form:input path="start" id="start" class="form-control" placeholder="dd/MM/yyyy" readonly="true" />
				<span class="input-group-addon">
					<i class="glyphicon glyphicon-calendar"></i>
				</span>
			</div>
			<form:errors path = "start" cssClass = "label label-danger" />
		</div>
	</div>
	<div class="form-group">
