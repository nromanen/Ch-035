...
jQuery.extend(jQuery.validator.messages, {
    ...
    maxlength: jQuery.validator.format("<spring:message code="crsms.error.too.longer"/> {0}."),
    minlength: jQuery.validator.format("<spring:message code="crsms.error.too.shorter"/> {0}."),
